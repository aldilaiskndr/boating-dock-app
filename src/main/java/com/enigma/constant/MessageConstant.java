...
public class MessageConstant {
    public static final String CREATED_BOATING_DOCK ="Created a boating dock with %s piers";
    public static final String CREATED_BOATING_DOCK_FAIL = "Sorry, given capacity must more than 0";
    ...
    public static final String COMMAND_NOT_FOUND = "Sorry, no suitable commands";
